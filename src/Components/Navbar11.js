      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" color='secondary'>
          <Toolbar>
            ...
            <Button color="inherit" component={NavLink} style={({isActive}) => { return {backgroundColor: isActive ? "#6d1b7b" : ""}}} sx={{textTransform: "none"}} to="/login">Login/Regsitration1</Button>
          </Toolbar>
        </AppBar>
      </Box>    </>
  )
